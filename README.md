...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/0c5037d406264280a4eb2cc76d115199)](https://www.codacy.com/app/michaelruocco/wso2-api-manager-client?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=michaelruocco/wso2-api-manager-client&amp;utm_campaign=Badge_Grade)
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.github.michaelruocco/wso2-api-manager-client/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.github.michaelruocco/wso2-api-manager-client)
...
```
dependencies {
    compile group: 'com.github.michaelruocco', name: 'wso2-api-manager-client', version: '5.0.3'
}
```
